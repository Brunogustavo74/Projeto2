      ...
      <AlertDialog open={showPasswordModal} onOpenChange={setShowPasswordModal}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Você está prestes a alterar sua senha. Após a alteração, você precisará usar a nova senha para fazer login.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            <AlertDialogCancel disabled={isChangingPassword}>Cancelar</AlertDialogCancel>
            <AlertDialogAction onClick={handleConfirmPasswordChange} disabled={isChangingPassword}>
              {isChangingPassword ? (
                <div className="w-4 h-4 border-2 border-primary-foreground/30 border-t-primary-foreground rounded-full animate-spin" />
              ) : (
                "Confirmar"
        ...
        <DialogContent className="sm:max-w-md">
          ...
          <DialogFooter className="gap-2 sm:gap-0">
            ...
            <Button
              ...
              disabled={deleteConfirmation !== "quero deletar" || isDeletingAccount}
              className="gap-2"
            >
              {isDeletingAccount ? (
